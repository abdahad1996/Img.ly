...
public struct DesignLibrary: DesignLibraryProvider {
  ...
  public let miscellaneous: MiscellaneousTokensProvider = MiscellaneousTokens()
}
...
public struct DesignLibraryAlternative: DesignLibraryProvider {
  ...
  public let miscellaneous: MiscellaneousTokensProvider = MiscellaneousTokensAlternative()
}
