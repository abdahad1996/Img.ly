...
struct BaseColors: BaseColorsProvider {
    ...
    let brandSecondary = Color(
        red: 219 / 255, green: 246 / 255, blue: 111 / 255)
    let white = Color(red: 255 / 255, green: 255 / 255, blue: 255 / 255)
    let dark = Color(red: 100 / 255, green: 100 / 255, blue: 100 / 255)
...
struct BaseColorsAlternative: BaseColorsProvider {
    let brandPrimary = Color(red: 75 / 255, green: 23 / 255, blue: 245 / 255)
    let brandSecondary = Color(
        red: 255 / 255, green: 152 / 255, blue: 195 / 255)
    let cream = Color(red: 255 / 255, green: 253 / 255, blue: 194 / 255)
